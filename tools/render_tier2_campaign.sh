#!/usr/bin/env bash
# Tier-2 recovery campaign, Stage B driver: renders tier2_recovery chunks as the
...
SRC=${SRC:-/home/pandaliza/parallax/data/vla_train/tier2_recovery}
DST=${DST:-/home/pandaliza/parallax/data/vla_train/tier2_recovery_gs}
CHUNKS=${CHUNKS:-8}
CAMPAIGN_SEED=${CAMPAIGN_SEED:-888}
cd "$REPO"
